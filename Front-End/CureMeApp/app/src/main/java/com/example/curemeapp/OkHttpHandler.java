...
public class OkHttpHandler {
    ...
    public ArrayList<Patient> requestPatientData (String url) throws Exception{
        ...
        try {
            ...
            for (int i=0; i<jsonArray.length(); i++) {
                ...
                patientList.add(new Patient( patient_name,patient_phoneNumber,patient_AMKA, R.drawable.cont2));
            }
